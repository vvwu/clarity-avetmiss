...
public class LabelValue implements Comparable<LabelValue>, Serializable {
    ...
    /**
     * Create a new Label (note value is the first parameter, and label is the second)
     * @param value
     * @param label
     * @return
     */
    public static LabelValue create(final String value, final String label) {
